...
ggplot(dd, aes(age)) + geom_bar(aes(fill = vote_trump))
ggplot(dd, aes(age)) + geom_bar(aes(fill = vote_biden))
```
...
ggplot(dd, aes(employment)) + geom_bar(aes(fill = vote_trump))
ggplot(dd, aes(employment)) + geom_bar(aes(fill = vote_biden))
```
...
ggplot(dd, aes(race_ethnicity)) + geom_bar(aes(fill = vote_trump))
ggplot(dd, aes(race_ethnicity)) + geom_bar(aes(fill = vote_biden))
```
...
ggplot(dd, aes(gender)) + geom_bar(aes(fill = vote_trump))
ggplot(dd, aes(gender)) + geom_bar(aes(fill = vote_biden))
```
