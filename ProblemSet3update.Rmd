...
Please refer to the Appendix: code for details.
...
The popular vote outcome for Trump is:
```{r, echo=FALSE}
...
The popular vote outcome for Biden is:
```{r, echo=FALSE}
...
Please refer to the Appendix section: table `polling` for details.
...
```
The electoral vote outcome for Trump is:
```{r, echo=FALSE}
sum(polling$trump_victory * polling$electoral_votes)
```
The electoral vote outcome for Biden is:
```{r, echo=FALSE}
